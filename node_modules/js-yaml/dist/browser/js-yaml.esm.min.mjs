...
}), Ue = r("tag:yaml.org,2002:omap", {
	create: () => [],
	addItem: (e, t) => {
		if (Object.prototype.toString.call(t) !== "[object Object]") return "cannot resolve an ordered map item";
		let n = t, r = Object.keys(n);
		if (r.length !== 1) return "cannot resolve an ordered map item";
		for (let t of e) if (Object.prototype.hasOwnProperty.call(t, r[0])) return "cannot resolve an ordered map item";
		return e.push(n), "";
	}
}), We = r("tag:yaml.org,2002:pairs", {
	create: () => [],
	addItem: (e, t) => {
...
var qe = i("tag:yaml.org,2002:map", {
	create: () => ({}),
	identify: Ge,
	represent: (e) => {
...
function Yn(e, t = {}) {
	...
	return cn(qn(r, Ke(n, i)), y(y({}, Ke(n, a)), {}, { source: r }));
}
function Xn(e, t, n) {
	let r = null;
...
function pi(e, t = {}) {
	...
	}), n.transform(r), ui(r, y(y({}, Ke(n, Object.keys(Or))), {}, { schema: n.schema }));
}
//#endregion
